 ...
 * <p>
 * This class provides methods for retrieving named loggers and registering log markers
 ...
 *
 * <p>
 * This class is designed as a utility with static methods and cannot be instantiated.
 * </p>
 *
...
public class LogZeus {
     ...
     * <p>
     * If a marker with the given name already exists in the cache, it is returned.
     ...
     * <p>
     * If no marker with the given name exists, this method returns {@code null}.
     * </p>
     *
     ...
     * <p>
     * The logger is retrieved using Log4j2's {@link LogManager}, ensuring that
     ...
     * <p>
     * This allows for dynamically named loggers, useful in scenarios where a specific
