 ...
 * <p>
 * Implementations of this interface define the logic for dynamically splitting test methods
 ...
 * filtering, sorting, and bucketing strategies for test distribution.</p>
 *
...
public interface TestAllocatorService {
     ...
     * <p>
     * Implementations will analyze test classes and methods, apply relevant filters,
