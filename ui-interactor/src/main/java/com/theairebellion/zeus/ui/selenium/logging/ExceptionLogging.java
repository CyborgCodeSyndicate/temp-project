 ...
 *
 * <p>Each entry in the enum defines a WebDriver or WebElement action along with
...
public enum ExceptionLogging {
    ...
    */
   private final Map<Class<? extends Throwable>, FourConsumer<Object, WebElementAction, Object[],
