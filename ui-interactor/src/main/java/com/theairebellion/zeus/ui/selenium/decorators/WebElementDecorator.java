 ...
 * <p>
 * This abstract class delegates all method calls to the original {@link WebElement}, allowing
 * extensions to enhance WebElement interactions without modifying the core Selenium API.
 * </p>
 *
 * <p>
 * Subclasses can override specific methods to add custom behavior, such as logging, exception handling,
