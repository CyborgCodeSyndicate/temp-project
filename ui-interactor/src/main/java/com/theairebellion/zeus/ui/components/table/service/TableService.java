 ...
 * filtering, and sorting table data dynamically.</p>
 *
...
public interface TableService {
    ...
    /**
     * Reads a specific range of rows from the table with only the specified fields using a specific table component type.
     *
     * @param tableComponentType The type of the table component.
     * @param start              The starting row index (inclusive, 1-based index).
     * @param end                The ending row index (exclusive, 1-based index).
     ...
     * and returns it as an object of the provided class.</p>
     *
     * @param tableComponentType The type of the table component.
     * @param searchCriteria     A list of string values used to identify the row.
     * @param clazz              The class type representing the table row.
     ...
     * only the specified fields from the row.</p>
     *
     ...
     *
     * <p>This method searches for a row that matches the given criteria within the specified table component
     * and extracts only the specified fields.</p>
     *
     * @param tableComponentType The type of the table component.
     * @param searchCriteria     A list of string values used to identify the row.
     * @param clazz              The class type representing the table row.
     ...
     *
     * <p>This method inserts values into the fields of a specified row in the table using the default table component type.</p>
     *
     ...
     *
     * <p>This method inserts values into the fields of a specified row in the table for a given table component type.</p>
     *
     * @param tableComponentType The type of the table component.
     * @param row                The 1-based index of the row where values should be inserted.
     * @param tClass             The class type representing the table row.
     ...
     *
     * <p>This method inserts values into a particular field of a specified row.</p>
     *
     ...
     *
     * <p>This method inserts values into a particular field of a specified row for a given table component type.</p>
     *
     * @param tableComponentType The type of the table component.
     * @param row                The 1-based index of the row where the values should be inserted.
     * @param tClass             The class type representing the table row.
     ...
     *
     * <p>This method inserts values into a specified field of a row at a particular index position.</p>
     *
     * @param row    The 1-based index of the row where the values should be inserted.
     * @param tClass The class type representing the table row.
     * @param field  The field in which values should be inserted.
     ...
     * for a given table component type.</p>
     *
     * @param tableComponentType The type of the table component.
     * @param row                The 1-based index of the row where the values should be inserted.
     * @param tClass             The class type representing the table row.
     ...
     * using a specified table component type. It defaults to inserting at the first available index.</p>
     *
     * @param tableComponentType The type of the table component.
     * @param searchCriteria     A list of string values used to identify the row.
     * @param tClass             The class type representing the table row.
     ...
     *
     * <p>This method inserts values into a particular field of a row that matches the given search criteria
     * using the default table component type at a specified cell index.</p>
     *
     * @param searchCriteria A list of string values used to identify the row.
     * @param tClass         The class type representing the table row.
     * @param field          The field in which values should be inserted.
    ...
    /**
     * Inserts values into a specific indexed cell within a row that matches the search criteria using a specified table component type.
     *
     * <p>This method inserts values into a particular field of a row that matches the given search criteria
     * at a specified cell index.</p>
     *
     * @param tableComponentType The type of the table component.
     * @param searchCriteria     A list of string values used to identify the row.
     * @param tClass             The class type representing the table row.
     ...
     * using the default table component type.</p>
     *
     * @param searchCriteria A list of string values used to identify the row.
     * @param tClass         The class type representing the table row.
     * @param data           The object containing the values to insert.
    ...
    /**
     * Inserts values into all applicable fields of a row that matches the search criteria using a specified table component type.
     *
     * <p>This method inserts values into all fields of a row that matches the given search criteria.</p>
     *
     * @param tableComponentType The type of the table component.
     * @param searchCriteria     A list of string values used to identify the row.
     * @param tClass             The class type representing the table row.
     ...
     * using the specified table component type.</p>
     *
     * @param tableComponentType The type of the table component.
