 ...
 *
 * <p>This is a functional interface, meaning it can be used as the target for lambda expressions and method references.
 * Similar to {@link java.util.function.BiConsumer}, it allows defining custom two-parameter operations.
 *
 * <p>The first input argument, {@code T}, represents the primary entity on which the operation is performed.
