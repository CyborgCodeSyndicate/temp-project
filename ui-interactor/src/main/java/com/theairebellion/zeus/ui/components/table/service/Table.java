 ...
 * <p>
 * This interface provides methods for reading table data, retrieving rows based on different criteria,
 ...
 * </p>
 *
 * <p>Implementations of this interface are expected to handle the underlying table processing.</p>
 *
...
public interface Table {
     ...
     * @param <T>    The type of the row representation.
     */
    <T> void insertCellValue(int row, Class<T> tClass, TableField<T> field, int index, String... values);
     ...
     * @param <T>            The type of the row representation.
     */
    default <T> void insertCellValue(List<String> searchCriteria, Class<T> tClass, TableField<T> field, String... values) {
     ...
     * @param <T>            The type of the row representation.
     */
    <T> void insertCellValue(List<String> searchCriteria, Class<T> tClass, TableField<T> field, int index, String... values);
