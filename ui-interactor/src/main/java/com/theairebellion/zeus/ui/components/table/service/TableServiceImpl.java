 ...
 * <p>
 * This service is responsible for reading tables and rows, inserting values,
...
public class TableServiceImpl extends AbstractComponentService<TableComponentType, Table> implements TableService {
     ...
     * @param searchCriteria     A list of string values used to locate the row.
     * @param clazz              The class type representing the row structure.
     * @param fields             The specific fields to retrieve from the row. If not provided, all fields will be retrieved.
     * @param <T>                The type of the row representation.
     ...
     * @param tableComponentType The type of the table component.
     * @param row                The row index (1-based index).
     * @param tClass             The class type representing the row.
     ...
     */
    @Override
    public final  <T> void sortTable(final TableComponentType tableComponentType, final Class<T> tclass, final TableField<T> column, final SortingStrategy sortingStrategy) {
