 ...
 *
 * <p>This class serves as a generic service layer for handling UI components of various types.
 * It maintains a registry of component instances and ensures efficient reuse.
 *
 * <p>Implementing classes must define how components are created based on a {@link ComponentType}.
...
public abstract class AbstractComponentService<T extends ComponentType, C> {
    ...
    *
    * <p>If a component of the given type does not exist, it is created and stored.
    *
    ...
    *
    * <p>Subclasses must provide an implementation to initialize components of type {@code C}.
    *
