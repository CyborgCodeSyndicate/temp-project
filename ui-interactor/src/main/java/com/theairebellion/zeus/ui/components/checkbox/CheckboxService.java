 ...
 *
 * <p>This interface defines operations to select, deselect, and verify the state
...
public interface CheckboxService extends Insertion {
   ...
   /**
    * Checks if the checkboxes with the specified text inside a container are selected, using the default checkbox
    * component type.
    *
    * @param container    The SmartWebElement container that contains the checkboxes.
   ...
   /**
    * Checks if the checkboxes with the specified text inside a container are selected, using the given checkbox
    * component type.
    *
    * @param componentType The specific checkbox component type.
    * @param container     The SmartWebElement container that contains the checkboxes.
   ...
   /**
    * Checks if the checkboxes identified by the specified locators are selected, using the default checkbox
    * component type.
    *
   ...
   /**
    * Checks if the checkboxes identified by the specified locators are selected, using the given checkbox
    * component type.
    *
    * @param componentType   The specific checkbox component type.
    * @param checkBoxLocator The locators for the checkboxes to verify.
   ...
   /**
    * Checks if the checkbox with the specified text inside a container is selected, using the given checkbox
    * component type.
    *
    * @param componentType The specific checkbox component type.
    * @param container     The SmartWebElement container that contains the checkbox.
   ...
   /**
    * Checks if the checkboxes with the specified text inside a container are enabled, using the given checkbox
    * component type.
    *
    * @param componentType The specific checkbox component type.
    * @param container     The SmartWebElement container that contains the checkboxes.
   ...
   /**
    * Checks if the checkboxes identified by the specified locators are enabled, using the default checkbox
    * component type.
    *
    * @param checkBoxLocator The locators for the checkboxes to verify.
    * @return true if all specified checkboxes are enabled, false otherwise.
   ...
   /**
    * Checks if the checkboxes identified by the specified locators are enabled, using the given checkbox
    * component type.
    *
    * @param componentType   The specific checkbox component type.
    * @param checkBoxLocator The locators for the checkboxes to verify.
   ...
   /**
    * Checks if the checkbox with the specified text inside a container is enabled, using the default checkbox
    * component type.
    *
    * @param container    The SmartWebElement container that contains the checkbox.
    * @param checkBoxText The text of the checkbox to verify.
   ...
   /**
    * Checks if the checkbox with the specified text inside a container is enabled, using the given checkbox
    * component type.
    *
    * @param componentType The specific checkbox component type.
    * @param container     The SmartWebElement container that contains the checkbox.
   ...
   /**
    * Retrieves the text of all selected checkboxes inside a container identified by the specified locator, using the
    * default checkbox component type.
    *
   ...
   /**
    * Retrieves the text of all checkboxes inside a container, regardless of their state, using the default checkbox
    * component type.
    *
    * @param container The SmartWebElement container that contains the checkboxes.
   ...
   /**
    * Retrieves the text of all checkboxes inside a container, regardless of their state, using the given checkbox
    * component type.
    *
    * @param componentType The specific checkbox component type.
    * @param container     The SmartWebElement container that contains the checkboxes.
   ...
   /**
    * Retrieves the text of all checkboxes inside a container identified by the specified locator, regardless of their
    * state, using the default checkbox component type.
    *
    * @param containerLocator The locator for the container that contains the checkboxes.
    * @return A list of strings representing the text of all checkboxes.
    */
   ...
   /**
    * Retrieves the text of all checkboxes inside a container identified by the specified locator, regardless of their
    * state, using the given checkbox component type.
    *
    * @param componentType    The specific checkbox component type.
    * @param containerLocator The locator for the container that contains the checkboxes.
    * @return A list of strings representing the text of all checkboxes.
