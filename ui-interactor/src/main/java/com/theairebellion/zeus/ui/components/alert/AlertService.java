 ...
 *
 * <p>Each method resolves the appropriate {@link AlertComponentType}—for instance,
 * corresponding to a particular UI framework—and delegates to the correct
 * {@link Alert} implementation under the hood.
 *
 * <p>The default alert type can be overridden by specifying an {@link AlertComponentType} parameter,
