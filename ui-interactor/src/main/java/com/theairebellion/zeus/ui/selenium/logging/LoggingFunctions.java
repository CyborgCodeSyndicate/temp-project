...
public class LoggingFunctions {
    ...
    public static void logFindElementFromRootNoSuchElementException(final Object target, final WebElementAction webElementAction, final Object[] args,
        ...
        logException(cause.getClass(), target, webElementAction.getMethodName(), args, additionalInfo);
    }

    public static void logNoSuchElementException(final Object target, final WebElementAction webElementAction, final Object[] args,
                                                 final InvocationTargetException e) {
        Throwable cause = e.getCause();
        ...
        if (element == null) {
            logException(cause.getClass(), target, webElementAction.getMethodName(), args,
        ...
        String actionMessage = switch (webElementAction) {
            ...
            case CLICK -> String.format("Exception [%s]: Click action failed on element [%s] with text [%s]. " +
                            "Possible reasons: element is disabled or outside the viewport.",
            ...
            case SEND_KEYS -> String.format("Exception [%s]: Unable to send keys to element [%s] with text [%s]. " +
                            "Possible reasons: element is not interactable, read-only, or detached from the DOM.",
                    cause.getClass().getSimpleName(), elementTagName, elementText);
    ...
    public static void logElementNotInteractableException(final Object target, final WebElementAction webElementAction, final Object[] args,
                                                          final InvocationTargetException e) {
        Throwable cause = e.getCause();
        WebElement element = (target instanceof WebElement) ? (WebElement) target : null;

        if (element == null) {
            logException(cause.getClass(), target, webElementAction.getMethodName(), args, "Element is null, cannot log additional info.");
            return;
        }
        ...
        String additionalInfo = String.format(
                """
                        ...
                        %s""",
                cause.getClass().getSimpleName(), elementTagName, elementText, webElementAction.getMethodName(), elementAttributes);

        logException(cause.getClass(), target, webElementAction.getMethodName(), args, additionalInfo);
    }

    public static void logClickInvalidSelectorException(final Object target, final WebElementAction webElementAction, final Object[] args, final InvocationTargetException e) {
        By locator = (args != null && args.length > 0 && args[0] instanceof By) ? (By) args[0] : null;
        Throwable cause = e.getCause();
    ...
    public static void logElementClickInterceptedException(final Object target, final WebElementAction webElementAction, final Object[] args,
                                                           final InvocationTargetException e) {
        Throwable cause = e.getCause();
        WebElement element = (target instanceof WebElement) ? (WebElement) target : null;
        ...
        String additionalInfo = String.format(
                ...
                webElementAction.getMethodName(), element, elementInnerHtml, blockingElementLocator);

        logException(cause.getClass(), target, webElementAction.getMethodName(), args, additionalInfo);
    }

    public static void logClickTimeoutException(final Object target, final WebElementAction webElementAction, final Object[] args,
                                                final InvocationTargetException e) {
        Throwable cause = e.getCause();
        By locator = (args != null && args.length > 0 && args[0] instanceof By) ? (By) args[0] : null;
        ...
        String additionalInfo = String.format(
                ...
                webElementAction.getMethodName(), locator != null ? locator.toString() : "Unknown locator", timeoutMessage);
        logException(cause.getClass(), target, webElementAction.getMethodName(), args, additionalInfo);
