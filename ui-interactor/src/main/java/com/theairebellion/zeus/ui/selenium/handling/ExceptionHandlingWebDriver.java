 ...
 *
 * <p>This enum maps specific WebDriver methods to exception handling logic, allowing
...
public enum ExceptionHandlingWebDriver {
   ...
   FIND_ELEMENT("findElement",
         Map.of(
               ...
               (driver, objects) ->
                     ExceptionHandlingWebDriverFunctions.handleNoSuchElement(driver,
                           WebElementAction.FIND_ELEMENT, objects)
         )),
   ...
   FIND_ELEMENTS("findElements",
         Map.of(
               ...
               (driver, objects) ->
                     ExceptionHandlingWebDriverFunctions.handleNoSuchElement(driver,
                           WebElementAction.FIND_ELEMENTS, objects)
         ));
   ...
   ExceptionHandlingWebDriver(final String methodName,
                              Map<Class<? extends Throwable>, BiFunction<WebDriver,
