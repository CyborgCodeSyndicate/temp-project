 ...
 * container/locator handling, ensuring consistent behavior across different UI designs.
 *
...
public interface RadioService extends Insertion {
   ...
   /**
    * Checks if a radio button within a container is enabled based on the button text. Uses the default radio
    * component type.
    *
    * @param container       The SmartWebElement that contains the radio buttons.
   ...
   /**
    * Checks if a radio button within a container is selected based on the button text. Uses the default radio
    * component type.
    *
    * @param container       The SmartWebElement that contains the radio buttons.
    * @param radioButtonText The text of the radio button to check.
   ...
   /**
    * Checks if a radio button within a container is selected based on the button text and specific radio
    * component type.
    *
    * @param componentType   The specific type of radio component.
    * @param container       The SmartWebElement that contains the radio buttons.
   ...
   /**
    * Checks if a radio button within a container is visible based on the button text. Uses the default radio
    * component type.
    *
    * @param container       The SmartWebElement that contains the radio buttons.
    * @param radioButtonText The text of the radio button to check.
   ...
   /**
    * Gets the text of the selected radio button within a container, specified by its locator. Uses the default radio
    * component type.
    *
   ...
   /**
    * Gets the text of the selected radio button within a container, specified by its locator, based on a specific
   ...
   /**
    * Gets all the texts of the radio buttons within a container, specified by its locator. Uses the default radio
    * component type.
    *
    * @param containerLocator The By locator for the container element that contains the radio buttons.
   ...
   /**
    * Gets all the texts of the radio buttons within a container, specified by its locator, based on a specific radio
    * component type.
    *
    * @param componentType    The specific type of radio component.
    * @param containerLocator The By locator for the container element that contains the radio buttons.
