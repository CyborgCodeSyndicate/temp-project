 ...
 * <p>
 * This interface provides a contract for custom cell insertion logic,
 * enabling dynamic handling of table cell modifications.
 * </p>
 *
 * <p>It is used in {@code TableImpl}, {@code CellLocator}, {@code TableEntry}, and {@code CustomCellInsertion}.</p>
 *
