 ...
 * <p>
 * This class ensures a single shared instance of the UI configuration throughout the application.
...
public class UiConfigHolder {
     ...
     * <p>
     * If the configuration has not been initialized, it will be created using {@link ConfigCache}.
     * </p>
     *
