 ...
 *
 * <p>Supports operations like retrieving text values and web elements from fields of type {@link TableCell}
...
public final class TableReflectionUtil {
   ...
   /**
    * Extracts all {@link SmartWebElement} instances from fields of type {@link TableCell} or {@code List<TableCell>}
    * within a given row object.
    *
    * @param row The row object containing {@link TableCell} fields.
