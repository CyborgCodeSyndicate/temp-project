...
public class RadioServiceImpl extends AbstractComponentService<RadioComponentType, Radio> implements RadioService {
    ...
    private static final String SELECT_RADIO_WITH_TEXT_CONTAINER   = "Selecting radio button with text %s in container %s for radio component %s";
    private static final String SELECT_RADIO_WITH_STRATEGY         = "Selecting radio button with strategy %s in container %s for radio component %s";
    private static final String SELECT_RADIO_WITH_TEXT             = "Selecting radio button with text %s for radio component %s";
    private static final String SELECT_RADIO_WITH_LOCATOR          = "Selecting radio button with locator %s for radio component %s";

    private static final String CHECK_RADIO_ENABLED_CONTAINER      = "Checking if radio button with text %s is enabled in container %s for radio component %s";
    private static final String CHECK_RADIO_ENABLED_TEXT           = "Checking if radio button with text %s is enabled for radio component %s";
    private static final String CHECK_RADIO_ENABLED_LOCATOR        = "Checking if radio button with locator %s is enabled for radio component %s";

    private static final String CHECK_RADIO_SELECTED_CONTAINER     = "Checking if radio button with text %s is selected in container %s for radio component %s";
    private static final String CHECK_RADIO_SELECTED_TEXT          = "Checking if radio button with text %s is selected for radio component %s";
    private static final String CHECK_RADIO_SELECTED_LOCATOR       = "Checking if radio button with locator %s is selected for radio component %s";

    private static final String CHECK_RADIO_VISIBLE_CONTAINER      = "Checking if radio button with text %s is visible in container %s for radio component %s";
    private static final String CHECK_RADIO_VISIBLE_TEXT           = "Checking if radio button with text %s is visible for radio component %s";
    private static final String CHECK_RADIO_VISIBLE_LOCATOR        = "Checking if radio button with locator %s is visible for radio component %s";

    private static final String GET_SELECTED_RADIO_CONTAINER       = "Getting selected radio button text from container %s for radio component %s";
    private static final String GET_SELECTED_RADIO_LOCATOR         = "Getting selected radio button text from locator %s for radio component %s";

    private static final String GET_ALL_RADIOS_CONTAINER           = "Getting all radio buttons from container %s for radio component %s";
    private static final String GET_ALL_RADIOS_LOCATOR             = "Getting all radio buttons from locator %s for radio component %s";

    private static final String INSERT_RADIO_VALUES_LOCATOR        = "Inserting values %s for radio component %s using locator %s";
