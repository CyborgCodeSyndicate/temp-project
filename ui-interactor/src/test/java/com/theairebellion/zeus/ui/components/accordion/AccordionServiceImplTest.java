...
class AccordionServiceImplTest {
    ...
    private AccordionMockComponentType accordionMockComponentType;
    ...
    public void setUp() {
        ...
        accordionMockComponentType = AccordionMockComponentType.DUMMY;
    ...
    public void testExpandWithContainerAndText() {
        service.expand(accordionMockComponentType, container, "Panel1", "Panel2");
    ...
    public void testExpandWithContainerAndStrategy() {
        ...
        String result = service.expand(accordionMockComponentType, container, strategy);
    ...
    public void testExpandWithTextOnly() {
        service.expand(accordionMockComponentType, "Panel1");
    ...
    public void testExpandWithByLocator() {
        ...
        service.expand(accordionMockComponentType, locator);
        verify(accordionMock).expand(locator);
    }

    @Test
    public void testCollapseWithContainerAndText() {
        service.collapse(accordionMockComponentType, container, "Panel1");
    ...
    public void testCollapseWithContainerAndStrategy() {
        ...
        String result = service.collapse(accordionMockComponentType, container, strategy);
    ...
    public void testCollapseWithTextOnly() {
        service.collapse(accordionMockComponentType, "Panel1");
    ...
    public void testCollapseWithByLocator() {
        By locator = By.id("accordion");
        service.collapse(accordionMockComponentType, locator);
    ...
    public void testAreEnabledWithContainerAndText() {
        ...
        boolean result = service.areEnabled(accordionMockComponentType, container, "Panel1", "Panel2");
        assertTrue(result);
    ...
    public void testAreEnabledWithTextOnly() {
        ...
        boolean result = service.areEnabled(accordionMockComponentType, "Panel1");
        assertTrue(result);
    ...
    public void testAreEnabledWithByLocator() {
        ...
        boolean result = service.areEnabled(accordionMockComponentType, locator);
        assertTrue(result);
    ...
    public void testGetExpanded() {
        ...
        List<String> result = service.getExpanded(accordionMockComponentType, container);
    ...
    public void testGetCollapsed() {
        ...
        List<String> result = service.getCollapsed(accordionMockComponentType, container);
    ...
    public void testGetAll() {
        ...
        List<String> result = service.getAll(accordionMockComponentType, container);
    ...
    public void testGetTitle() {
        ...
        String result = service.getTitle(accordionMockComponentType, locator);
    ...
    public void testGetText() {
        ...
        String result = service.getText(accordionMockComponentType, locator);
    ...
    public void testComponentCaching() {
        service.expand(accordionMockComponentType, container, "Panel1");
        service.collapse(accordionMockComponentType, container, "Panel1");
        factoryMock.verify(() -> ComponentFactory.getAccordionComponent(eq(accordionMockComponentType), eq(driver)), Mockito.times(1));
    }
}
