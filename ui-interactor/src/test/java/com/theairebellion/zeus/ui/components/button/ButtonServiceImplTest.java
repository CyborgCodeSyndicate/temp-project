   ...
   class ProtectedMethodTests {
      ...
      void testCreateComponent() throws Exception {
         ...
         Method createComponentMethod =
               ButtonServiceImpl.class.getDeclaredMethod("createComponent", ButtonComponentType.class);
      ...
      void testButtonComponent() throws Exception {
         // Given
         Method buttonComponentMethod =
               ButtonServiceImpl.class.getDeclaredMethod("buttonComponent", ButtonComponentType.class);
