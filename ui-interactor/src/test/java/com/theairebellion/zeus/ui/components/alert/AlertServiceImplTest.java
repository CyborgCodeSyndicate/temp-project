...
class AlertServiceImplTest {
    ...
    class ProtectedMethodTests {
        ...
        void testCreateComponent() throws Exception {
            // Given
            java.lang.reflect.Method createComponentMethod = AlertServiceImpl.class.getDeclaredMethod("createComponent", AlertComponentType.class);
        ...
        void testAlertComponent() throws Exception {
            // Given
            java.lang.reflect.Method alertComponentMethod = AlertServiceImpl.class.getDeclaredMethod("alertComponent", AlertComponentType.class);
