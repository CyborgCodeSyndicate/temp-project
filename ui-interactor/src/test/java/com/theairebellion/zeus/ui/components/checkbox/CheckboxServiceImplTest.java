...
class CheckboxServiceImplTest extends BaseUnitUITest {
    ...
    class ProtectedMethodTests {
        ...
        void testCreateComponent() throws Exception {
            // Given
            Method createComponentMethod = CheckboxServiceImpl.class.getDeclaredMethod("createComponent", CheckboxComponentType.class);
        ...
        void testCheckboxComponent() throws Exception {
            // Given
            Method checkboxComponentMethod = CheckboxServiceImpl.class.getDeclaredMethod("checkboxComponent", CheckboxComponentType.class);
