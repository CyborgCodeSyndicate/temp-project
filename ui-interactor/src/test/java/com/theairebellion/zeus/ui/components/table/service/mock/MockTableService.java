...
public class MockTableService implements TableService {
   ...
   @Override
   public void insertCellValue(TableComponentType tableComponentType, int row, Class classType, Object data) {
   }

   @Override
   public void insertCellValue(TableComponentType tableComponentType, int row, Class classType, TableField field, int index, String... value) {
   }

   @Override
   public void insertCellValue(TableComponentType tableComponentType, List searchCriteria, Class classType, TableField field, int index, String... values) {
   }

   @Override
   public void insertCellValue(TableComponentType tableComponentType, List searchCriteria, Class classType, Object data) {
   }
