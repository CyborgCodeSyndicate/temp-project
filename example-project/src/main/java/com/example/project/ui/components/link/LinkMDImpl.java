...
public class LinkMDImpl extends BaseComponent implements Link {
    ...
    public LinkMDImpl(SmartWebDriver driver) {
        super(driver);
    }
    ...
    private SmartWebElement findLinkInContainer(SmartWebElement container, String linkText) {
        return container.findSmartElements(LINK_CLASS_NAME_SELECTOR).stream()
    ...
    private SmartWebElement findLinkByText(String linkText) {
        return driver.findSmartElements(LINK_CLASS_NAME_SELECTOR).stream()
