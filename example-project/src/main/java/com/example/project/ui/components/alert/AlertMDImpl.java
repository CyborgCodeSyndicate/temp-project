...
@ImplementationOfType(AlertFieldTypes.MD_ALERT)
public class AlertMDImpl extends BaseComponent implements Alert {

    private static final By ALERT_CONTAINER_LOCATOR = By.tagName("Alert");


    public AlertMDImpl(SmartSelenium smartSelenium) {
        super(smartSelenium);
    }
