package com.example.project.db.h2;
...
public class H2Database {
    ...
    public static void initialize(DatabaseConfiguration dbConfig, DatabaseService service) {
        InputStream schemaStream = H2Database.class.getClassLoader().getResourceAsStream(DB_H2_FILES_SCHEMA_SQL);
        ...
        Connection connection = service.dbClientManager.getConnector().getConnection(dbConfig);
    ...
    public static void executeScript(Connection connection, String scriptPath) {
        try (InputStream inputStream = H2Database.class.getClassLoader().getResourceAsStream(scriptPath)) {
