...
public class ZeroBankTest extends BaseTest {
    ...
    public void validatePurchaseCheckRadioButtons(Quest quest) {
        ...
        quest
            ...
            .alert()
            .validateValue(AlertFields.FOREIGN_CURRENCY_CASH, "Foreign currency cash was successfully purchased.")
            .complete();
    }
    ...
    public void tableAssert(Quest quest) {
        ...
        quest
            ...
            .table().validate(
                ...
                Assertion.builder().target(TABLE_VALUES).type(EVERY_ROW_CONTAINS_VALUES)
                    .expected(List.of("ONLINE TRANSFER REF #UKKSDRQG6L")).soft(true).build(),
                Assertion.builder().target(TABLE_VALUES).type(TABLE_DOES_NOT_CONTAIN_ROW)
                    .expected(List.of("random", "TEST", "222.2", "")).soft(true).build(),
                ...
                Assertion.builder().target(TABLE_VALUES).type(TABLE_DATA_MATCHES_EXPECTED).expected(expectedTable)
                    .soft(true).build(),
            ...
            .table().validate(
                ...
                Assertion.builder().target(ROW_VALUES).type(ROW_CONTAINS_VALUES)
                    .expected(List.of("2012-09-06", "ONLINE TRANSFER REF #UKKSDRQG6L")).soft(true).build())
            .complete();
    }
