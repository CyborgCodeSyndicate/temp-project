...
class DataExtractorsUiTest {
    ...
    void testTableRowExtractorWithIndicators() {
        ...
        // Create actual extractor from the class under test
        DataExtractor<TestTableRow> extractor = DataExtractorsUi.tableRowExtractor(TestKey.TEST_TABLE, "value a", "list value 2");
    ...
    void testTableRowExtractorWithIndicatorsNotFound() {
        ...
        // Create actual extractor from the class under test
        DataExtractor<TestTableRow> extractor = DataExtractorsUi.tableRowExtractor(TestKey.TEST_TABLE, "value x", "value y");
    ...
    void testMixedFieldTypes() {
        ...
        // Create actual extractor from the class under test
        DataExtractor<TestMixedRow> extractor = DataExtractorsUi.tableRowExtractor(TestKey.TEST_TABLE, "cell value", "list cell 1");
