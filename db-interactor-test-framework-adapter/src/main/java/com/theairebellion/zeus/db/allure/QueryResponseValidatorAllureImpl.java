 ...
 *
 * <p>This class extends {@link QueryResponseValidatorImpl} to integrate Allure
...
public class QueryResponseValidatorAllureImpl extends QueryResponseValidatorImpl {
    ...
    *
    * <p>This method overrides the parent implementation to add Allure step-based logging,
