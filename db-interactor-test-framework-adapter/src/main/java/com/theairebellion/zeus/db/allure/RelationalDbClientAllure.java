 ...
 *
 * <p>This class extends {@link RelationalDbClient} to integrate Allure logging,
...
public class RelationalDbClientAllure extends RelationalDbClient {
   ...
   /**
    * Constructs a new {@code RelationalDbClientAllure} instance with the specified connector and
    ...
    *
    * <p>This method overrides the parent implementation to include Allure step-based logging,
    ...
    *
    * <p>This method overrides the parent implementation to attach the executed SQL query,
