 ...
 *
 * <p>Implementations of this interface validate HTTP responses against a set of assertions,
...
public interface RestResponseValidator {
    ...
    *
    * <p>Implementations extract relevant data from the response and evaluate it using the assertions.
    *
