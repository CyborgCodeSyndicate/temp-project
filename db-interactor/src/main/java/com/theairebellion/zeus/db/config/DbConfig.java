...
public interface DbConfig extends PropertyConfig {
    ...
    *
    * <p>Used by reflection utilities to scan for entity classes and database hooks
    ...
    *
    * <p>Determines which {@code DbType} implementation (e.g., MySQL, PostgreSQL)
    ...
    *
    * <p>If provided, this URL will be used directly to establish connections,
