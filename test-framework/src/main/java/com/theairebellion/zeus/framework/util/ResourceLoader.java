 ...
 *
 * <p>This class provides a method to load an HTML template from the classpath
...
public class ResourceLoader {
    ...
    *
    * <p>The template file should be located within the project's resources directory.
    ...
    *
    * <p>This method uses the class loader of the {@link com.theairebellion.zeus.framework.extension.Craftsman}
