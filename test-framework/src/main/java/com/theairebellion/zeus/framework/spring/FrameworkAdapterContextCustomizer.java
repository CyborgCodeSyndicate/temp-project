 ...
 *
 * <p>This class is used to dynamically include extra packages during the Spring context initialization,
 ...
 *
 * <p>The customizer is applied by scanning the specified {@code basePackages} in an
 * {@link AnnotationConfigApplicationContext}, enabling the framework to discover and register additional beans
 * for test execution.
 *
 * <p>Instances of this class compare equality based on the {@code basePackages} array, ensuring that
...
public class FrameworkAdapterContextCustomizer implements ContextCustomizer {
   ...
   public String toString() {
      return "FrameworkAdapterContextCustomizer{" + "basePackages=" + Arrays.toString(basePackages) + '}';
   }
