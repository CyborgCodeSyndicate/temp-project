 ...
 *
 * <p>Implementations of this interface define two key elements:
 * <ul>
 ...
 *
 * <p>This interface is often used in conjunction with a retry mechanism that repeatedly calls
...
public interface RetryCondition<T> {
    ...
    *
    * <p>This function is typically called repeatedly by a retry mechanism until
    ...
    *
    * <p>If this predicate returns {@code true}, the retry mechanism can stop. Otherwise,
