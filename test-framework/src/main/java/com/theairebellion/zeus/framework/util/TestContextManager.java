...
public class TestContextManager {
    ...
    *
    * <p>This method extracts the {@link Quest} object from the global extension context store,
    ...
    *
    * <p>This method ensures that test arguments are persistently stored and can be retrieved later if needed.
    ...
    *
    * <p>This method stores the total number of parameters of the test method in the extension context.
   ...
   public static void initializeParameterTracking(ExtensionContext extensionContext) {
      extensionContext.getStore(ExtensionContext.Namespace
                  .create(TestContextManager.class, extensionContext.getUniqueId()))
            .getOrComputeIfAbsent(TOTAL_PARAMS_KEY,
                  key -> extensionContext.getRequiredTestMethod().getParameters().length);
   }
