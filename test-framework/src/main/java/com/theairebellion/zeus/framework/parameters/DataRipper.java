 ...
 * <p>
 * Implementations of this interface specify cleanup logic for removing
 * test-generated data, ensuring that test environments remain in a consistent state.
 * </p>
 *
 * <p>
 * The cleanup operation is executed via a {@link Consumer} that accepts a {@link SuperQuest} instance.
...
public interface DataRipper<T extends Enum<T>> {
     ...
     * <p>
     * Implementations return a {@link Consumer} that defines the cleanup logic,
     ...
     * <p>
     * This ensures that cleanup actions can be identified and referenced
