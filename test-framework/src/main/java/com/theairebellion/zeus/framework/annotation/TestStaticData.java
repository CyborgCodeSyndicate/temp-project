 ...
 * <p>
 * This annotation is used to define a class responsible for providing static test data.
 ...
 *
 * <p>
 * The framework dynamically instantiates the data provider and retrieves the test data,
...
public @interface TestStaticData {
     ...
     * <p>
     * The class must extend {@code DataProvider} and implement a method to return
