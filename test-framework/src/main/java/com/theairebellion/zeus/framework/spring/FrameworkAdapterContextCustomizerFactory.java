 ...
 * <p>
 * This class scans the test class for any {@link FrameworkAdapter} annotations, collects their specified base packages,
 * and constructs a {@link FrameworkAdapterContextCustomizer} to add those packages to the Spring context scan.
 * If no {@code @FrameworkAdapter} annotations are present, it returns {@code null}, indicating that no customization is needed.
 * </p>
 *
 * <p>
 * This approach allows for flexible configuration of additional base packages without modifying the default Spring context setup.
 * </p>
 *
 * <p>
...
public class FrameworkAdapterContextCustomizerFactory implements ContextCustomizerFactory {
    ...
    /**
     * Creates a new {@link ContextCustomizer} if the test class contains one or more {@link FrameworkAdapter} annotations.
     * <p>
     * Each adapter's base packages are gathered and combined, ensuring duplicates are removed before creating
