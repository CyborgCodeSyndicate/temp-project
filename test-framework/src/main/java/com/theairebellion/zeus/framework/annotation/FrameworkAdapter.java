 ...
 * <p>
 * This annotation is used to specify the base packages that should be included
 ...
 *
 * <p>
 * The framework automatically detects and processes classes annotated with {@code @FrameworkAdapter}
...
public @interface FrameworkAdapter {
     ...
     * <p>
     * These packages define the scope of the test adapter and ensure
