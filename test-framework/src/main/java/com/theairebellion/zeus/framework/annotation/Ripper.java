 ...
 * <p>
 * This annotation is used to specify cleanup actions that should be executed after a test completes.
 ...
 *
 * <p>
 * The specified targets correspond to predefined cleanup actions,
...
public @interface Ripper {
     ...
     * <p>
     * Each target represents a predefined cleanup operation that is dynamically resolved
