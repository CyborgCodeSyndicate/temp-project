 ...
 * <p>
 * This class ensures a single instance of {@code FrameworkConfig} is created
 * and provides a global access point for retrieving configuration values.
 * </p>
 *
 * <p>
 * The configuration is lazily initialized upon first access and cached for
...
public class FrameworkConfigHolder {
     ...
     * <p>
     * If the configuration is not yet initialized, it is created and cached
