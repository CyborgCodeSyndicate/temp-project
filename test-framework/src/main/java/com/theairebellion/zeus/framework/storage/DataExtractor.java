 ...
 * <p>
 * Implementations of this interface specify how to transform a stored object into a
 * typed result, allowing the framework to handle various data formats and structures
 * in a consistent manner.
 * </p>
 *
 * <p>
 * The extraction process can optionally involve a sub-key for nested or hierarchical data,
...
public interface DataExtractor<T> {
     ...
     * <p>
     * If this method returns {@code null}, no sub-key is used in the extraction process.
     * </p>
     *
     ...
     * <p>
     * This key corresponds to a logical identifier within the storage system.
     * </p>
     *
     ...
     * <p>
     * This method applies the extraction logic to convert the stored object
     * into a typed result of type {@code T}.
     * </p>
     *
